...
def SKindex():
    addon_log("SKindex")
    Menu('[COLOR blue]======[/COLOR][COLOR red]WELCOME TO SUPREMACY ADD-ON[/COLOR][COLOR blue]======[/COLOR]','','','','','','')
    ...
    Menu('[COLOR aqua]24/7 Shows[/COLOR]','',905,'http://stephen-builds.uk/art/24%207%20shows.png','http://stephen-builds.uk/art/20839702_10207884860798337_363786087_o.jpg','','')
