...
root_xml_url = "https://pastebin.com/raw/aRWDNYT4"  # url of the root xml file
...
__builtin__.search_db_location = "http://arbbuilds.org/bu/search.db"  # location of search db
