...
if action == None:
    from resources.lib.indexers import pycyph
    pycyph.indexer().root()

elif action == 'directory':
    from resources.lib.indexers import pycyph
    pycyph.indexer().get(url)

elif action == 'qdirectory':
    from resources.lib.indexers import pycyph
    pycyph.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import pycyph
    pycyph.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import pycyph
    pycyph.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import pycyph
    pycyph.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import pycyph
    pycyph.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import pycyph
    pycyph.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import pycyph
    pycyph.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import pycyph
    pycyph.indexer().search(url=None)

elif action == 'addSearch':
    from resources.lib.indexers import pycyph
    pycyph.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import pycyph
    pycyph.indexer().delSearch()
