...
class indexer:
    def __init__(self):
        ...
        self.cartoons_image = 'http://ftg.srve.io/addon/icons/Cartoons.png'
        self.cartoons_fanart = 'https://emldixon.files.wordpress.com/2013/04/cartoons.jpg'
        ...
        self.anime_image = 'http://ftg.srve.io/addon/icons/anime.png'
        self.anime_fanart = 'http://orig13.deviantart.net/94f6/f/2014/288/0/c/anime_collage_by_stillglass-d82zhd1.jpg'
    ...
    def root(self):
        try:
            self.list = [
            {
            'title': '[COLOR yellow]Cartoon Search[/COLOR]',
            'action': 'sntoons.cartoons',
            ...
            {
            'title': '[COLOR yellow]Cartoon Genres[/COLOR]',
            'action': 'sntoons.cartoongenres',
            'image': self.cartoons_image, #% (random.randint(1,10)),
            'fanart': self.cartoons_fanart
            },

            {
            'title': '[COLOR yellow]Cartoon Latest[/COLOR]',
            'action': 'sntoons.cartoons',
            ...
            {
            'title': '[COLOR yellow]Cartoon Popular[/COLOR]',
            'action': 'sntoons.cartoons',
            ...
            {
            'title': '[COLOR red]Anime Search[/COLOR]',
            'action': 'sntoons.anime',
            ...
            {
            'title': '[COLOR red]Anime Genres[/COLOR]',
            'action': 'sntoons.animegenres',
            'image': self.anime_image, #% (random.randint(1,10)),
            'fanart': self.anime_fanart
            },

            {
            'title': '[COLOR red]Anime Latest[/COLOR]',
            'action': 'sntoons.animestreams',
    ...
    def cartoons(self, url):
        try:
            ...
            for i in self.list: i.update({'nextaction': 'sntoons.cartoons', 'nexticon': self.cartoons_image % (random.randint(1,10)), 'nextfanart': self.cartoons_fanart})

            for i in self.list: i.update({'action': 'sntoons.cartoonstreams'})
    ...
    def cartoongenres(self):
        try:
            ...
            for i in genres: self.list.append({'title': i.title(), 'url': self.cartoongenres_link % i, 'image': self.cartoons_image % (random.randint(1,10)), 'fanart': self.cartoons_fanart, 'action': 'sntoons.cartoons'})
    ...
    def cartoonstreams(self, url, image, fanart):
        try:
            ...
            for i in self.list: i.update({'action': 'sntoons.cartoonplay'})
            for i in self.list: i.update({'fanart': self.cartoons_fanart})
    ...
    def anime(self, url):
        try:
            ...
            for i in self.list: i.update({'action': 'sntoons.animestreams'})
    ...
    def animegenres(self):
        try:
            ...
            for i in genres: self.list.append({'title': i, 'url': self.animegenres_link % i.replace(' ','%20'), 'image': self.anime_image % (random.randint(1,10)), 'fanart': self.anime_fanart, 'action': 'sntoons.anime'})
    ...
    def animestreams(self, url, image, fanart):
        try:
            ...
            for i in self.list: i.update({'action': 'sntoons.animeplay'})
            for i in self.list: i.update({'fanart': self.anime_fanart})
