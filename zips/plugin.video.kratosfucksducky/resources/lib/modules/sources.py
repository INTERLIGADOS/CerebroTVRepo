...
class sources:
        ...
        for i in range(0, (timeout * 2) + 60):
            try:
                ...
                try:
                    ...
                    pass
                try:
                    string4 = "Kratos is searching the web and gathering multiple links for: [COLOR yellow][B]%s (%s)[/COLOR][/B] - Time Elapsed: [COLOR ghostwhite]%s Seconds[/COLOR]"  % (title,year,str(timerange))
                    string5 = ''
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.kratosfucksducky.container.items'

        self.metaProperty = 'plugin.video.kratosfucksducky.container.meta'
