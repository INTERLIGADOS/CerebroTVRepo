...
from bc_meta import meta_info , meta_quality, meta_gvideo_quality, meta_host
from bc_net import OPEN_URL, random_agent, get_sources, get_files
from bc_commons import parseDOM, replaceHTMLCodes
from bc_titles import title_match, cleantitle_get, cleantitle_get_2, cleantitle_get_full, cleantitle_geturl, cleantitle_get_simple, cleantitle_query, cleantitle_normalize
        ...
        try:
            ...
            for url,referer in self.elysium_url:
				...
				if "embed.php" in url:
					...
					print ("SERIESONLINE TRY 2", r)


					try:
							
							r = BeautifulSoup(r)
							print ("SERIESONLINE TRY 3b", r)
							r = r.findAll('source')
							for u in r:
								...
								sources.append({'source': 'gvideo', 'quality': quality, 'provider': 'seriesonline', 'url': href, 'direct': True, 'debridonly': False})
					except:
						pass
					...
					try:
						...
						sources.append({'source': host, 'quality': quality, 'provider': 'seriesonline', 'url': href, 'direct': False, 'debridonly': False})
					except:
						pass
