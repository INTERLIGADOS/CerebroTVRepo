...
from bc_commons import quality_tag, google_tag, parseDOM, replaceHTMLCodes ,cleantitle_get, cleantitle_get_2, cleantitle_query, get_size, cleantitle_get_full
		...
		try:
			...
			for post in posts:
				try:
					...
					pass
			# print ("SCENEDOWN PASSED", self.elysium_url)		
        ...
        try:
			...
			for post in posts:
				try:
					...
					pass
			print "%s TV QUERY PASSED %s" % (self.base_link, self.elysium_url)
			return self.elysium_url
        except:
            return			
