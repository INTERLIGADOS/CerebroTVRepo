...
def getTrakt(url, post=None):
    try:
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '03d9f4cb1f7c32096cf14a4a0fefa7be02752bf6f2bb1444b4321a8d1d5f3f81', 'trakt-api-version': '2'}
        ...
        opost = {'client_id': '03d9f4cb1f7c32096cf14a4a0fefa7be02752bf6f2bb1444b4321a8d1d5f3f81', 'client_secret': '67f3868f83ae7d62cef8ab8801f050d4af534bb98fe08dce25ed5c96c55aae49', 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob', 'grant_type': 'refresh_token', 'refresh_token': control.setting('trakt.refresh')}
...
def authTrakt():
    try:
        ...
        result = getTrakt('/oauth/device/code', {'client_id': '03d9f4cb1f7c32096cf14a4a0fefa7be02752bf6f2bb1444b4321a8d1d5f3f81'})
        result = json.loads(result)
        ...
        for i in range(0, expires_in):
            try:
                ...
                r = getTrakt('/oauth/device/token', {'client_id': '03d9f4cb1f7c32096cf14a4a0fefa7be02752bf6f2bb1444b4321a8d1d5f3f81', 'client_secret': '67f3868f83ae7d62cef8ab8801f050d4af534bb98fe08dce25ed5c96c55aae49', 'code': device_code})
                r = json.loads(r)
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '03d9f4cb1f7c32096cf14a4a0fefa7be02752bf6f2bb1444b4321a8d1d5f3f81', 'trakt-api-version': '2', 'Authorization': 'Bearer %s' % token}
