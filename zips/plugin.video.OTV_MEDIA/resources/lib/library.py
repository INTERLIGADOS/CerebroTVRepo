...
class cLibrary:
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.OTV_MEDIA/?function=play&site=cHosterGui&sFileName=' + sFileName + '&sMediaUrl=' + sMediaUrl + '&sHosterIdentifier=' + sHosterIdentifier
        ...
        if sCat == '1':
            ...
            try:
                ...
                cConfig().showInfo('OTV_MEDIA', 'Element rajouté a la librairie')
    ...
    def getLibrary_old(self):
        ...
        xbmc.executebuiltin("Container.Update(special://userdata/addon_data/plugin.video.OTV_MEDIA/)")
