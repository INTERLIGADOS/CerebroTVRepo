...
def is_adult(channel_name):
    logger.info("resources.lib.httpkir.channeltools is_adult channel_name="+channel_name)
...
def get_channel_parameters(channel_name):
    ...
    if os.path.exists(channel_xml):
        ...
        # Imagenes: they are admitted url and local files inside "resources/images"
        ...
        logger.info("resources.lib.httpkir.channeltools get_channel_parameters "+channel_name+" -> "+repr(channel_parameters) )

    else:
        logger.info("resources.lib.httpkir.channeltools get_channel_parameters "+channel_name+".xml NOT found")
...
def get_channel_module(channel_name, package = "channels"):
    ...
    logger.info("resources.lib.httpkir.channeltools Importando " + package + channel_name)
    channels_module = __import__(package + channel_name)
    channel_module = getattr(channels_module,channel_name)
    logger.info("resources.lib.httpkir.channeltools Importado " + package + channel_name)
