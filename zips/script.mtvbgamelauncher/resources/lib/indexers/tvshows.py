...
class tvshows:
	def __init__(self):
		...
		self.search_link = control.apollo_link+'?action=search&type=tv&search='
		...
		self.all_link = control.apollo_static_link+'movietv.meta/tv/tv.all.json'
		self.popular_link = control.apollo_static_link+'movietv.meta/tv/tv.popular.json'
		self.airing_link = control.apollo_static_link+'movietv.meta/tv/tv.airing.json'
		self.active_link = control.apollo_static_link+'movietv.meta/tv/tv.active.json'
		self.premiere_link = control.apollo_static_link+'movietv.meta/tv/tv.premiere.json'
		self.rating_link = control.apollo_static_link+'movietv.meta/tv/tv.rating.json'
		self.views_link = control.apollo_static_link+'movietv.meta/tv/tv.views.json'
		self.person_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&role=%s&sort=year,desc&count=100&start=1'
		self.network_link = control.apollo_static_link+'movietv.meta/tv/tv.network.%s.json'
		self.genre_link = control.apollo_static_link+'movietv.meta/tv/tv.genre.%s.json'
		self.certification_link = control.apollo_static_link+'movietv.meta/tv/tv.certification.%s.json'
		self.trending_link = control.apollo_static_link+'movietv.meta/tv/tv.trending.json'
	...
	def apollo_list(self, url):
		try:
			...
			for data in json_object:
				...
				try:
					#print "####### JSON Rec: {0}".format(data)
					self.list.append({'title': str(data['title']),'originaltitle': str(data['title']), 'year': str(data['year']), 'code': str(data['imdb']), 'imdb': str(data['imdb']), 'tmdb': '0', 'tvdb': str(data['tvdb']), 'poster': str(data['poster']), 'banner': str(data['banner']), 'fanart': str(data['fanart']), 'premiered': str(data['premiered']), 'studio': str(data['studio']), 'genre': str(data['genre']), 'duration': str(data['duration']), 'rating': str(data['rating']), 'votes': str(data['votes']), 'mpaa': str(data['mpaa']), 'cast': '0', 'plot': str(data['plot'])})
				except: 
	...
	def super_info(self, i):
		try:
			...
			try:
				if not tvdb == '0':
					response = get(control.apollo_link+'?action=meta&type=tv&id='+tvdb)
				else:
					pass
				...
				if 'title' in data:
					...
					self.list[i].update({'title': title, 'year': str(data['year']), 'code': str(data['imdb']), 'imdb': str(data['imdb']), 'tmdb': '0', 'tvdb': str(data['tvdb']), 'poster': str(data['poster']), 'banner': str(data['banner']), 'fanart': str(data['fanart']), 'premiered': str(data['premiered']), 'studio': str(data['studio']), 'genre': str(data['genre']), 'duration': str(data['duration']), 'rating': str(data['rating']), 'votes': str(data['votes']), 'mpaa': str(data['mpaa']), 'cast': '0', 'plot': plot})
					self.meta.append({'imdb': str(data['imdb']), 'tmdb': '0', 'tvdb': str(data['tvdb']), 'lang': self.lang, 'item': {'title': title, 'year': str(data['year']), 'code': str(data['imdb']), 'imdb': str(data['imdb']), 'tmdb': '0', 'tvdb': str(data['tvdb']), 'poster': str(data['poster']), 'banner': str(data['banner']), 'fanart': str(data['fanart']), 'premiered': str(data['premiered']), 'studio': str(data['studio']), 'genre': str(data['genre']), 'duration': str(data['duration']), 'rating': str(data['rating']), 'votes': str(data['votes']), 'mpaa': str(data['mpaa']), 'cast': '0', 'plot': plot}})
				else:
					self.list[i]['imdb'] = "0"
					self.list[i]['tvdb'] = "0"
			except:
