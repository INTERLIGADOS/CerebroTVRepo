...
class navigator:
	def root(self):
		...
		self.addDirectoryItem("TV Guide", 'apollotvguide', 'channels.png', 'DefaultMovies.png')
		self.addDirectoryItem(32010, 'searchNavigator', 'search.png', 'DefaultFolder.png')
		self.addDirectoryItem(32008, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png')
		if control.addon().getSetting('apollo.paid') == "false":
				item = control.item(label="[COLOR red]Slots are full? Become a member today, visit http://user.ApolloGroup.tv[/COLOR]")
	...
	def movies(self, lite=False):
		self.addDirectoryItem(32039, 'movies&url=all', 'userlists.png', 'DefaultRecentlyAddedMovies.png')
	...
	def tvshows(self, lite=False):
		self.addDirectoryItem(32040, 'tvshows&url=all', 'userlists.png', 'DefaultTVShows.png')
	...
	def search(self):
		...
		self.addDirectoryItem(32007, 'channelSearch', 'search.png', 'DefaultMovies.png')
