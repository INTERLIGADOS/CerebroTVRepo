...
if appversion == "SPMC":
    ...
    shutil.rmtree(xbmc.translatePath('/storage/emulated/0/Android/data/org.xbmc.kodi/files/.kodiaddons/'))
    xbmc.sleep(5000)
    shutil.rmtree(xbmc.translatePath('/storage/emulated/0/Android/data/org.xbmc.kodi/files/.kodiuserdata/'))
    xbmc.sleep(5000)
