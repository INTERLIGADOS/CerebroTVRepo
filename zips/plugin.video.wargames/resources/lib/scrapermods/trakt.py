...
from resources.lib.scrapermods import cache
from resources.lib.scrapermods import control
from resources.lib.scrapermods import cleandate
...
def getTrakt(url, post=None):
    try:
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '02372699a8b9094478989c43e3d45dec1881ea3dbb9d4d24c66a018d326fd0e4', 'trakt-api-version': '2'}
        ...
        opost = {'client_id': '02372699a8b9094478989c43e3d45dec1881ea3dbb9d4d24c66a018d326fd0e4', 'client_secret': '02766ee1c01944d0f88fc78a9325bb70bf7a8b43ae6c43e739c5e1478f7e5212', 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob', 'grant_type': 'refresh_token', 'refresh_token': control.setting('trakt.refresh')}
...
def authTrakt():
    try:
        ...
        result = getTrakt('/oauth/device/code', {'client_id': '02372699a8b9094478989c43e3d45dec1881ea3dbb9d4d24c66a018d326fd0e4'})
        result = json.loads(result)
        ...
        for i in range(0, expires_in):
            try:
                ...
                r = getTrakt('/oauth/device/token', {'client_id': '02372699a8b9094478989c43e3d45dec1881ea3dbb9d4d24c66a018d326fd0e4', 'client_secret': '02766ee1c01944d0f88fc78a9325bb70bf7a8b43ae6c43e739c5e1478f7e5212', 'code': device_code})
                r = json.loads(r)
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '02372699a8b9094478989c43e3d45dec1881ea3dbb9d4d24c66a018d326fd0e4', 'trakt-api-version': '2', 'Authorization': 'Bearer %s' % token}
