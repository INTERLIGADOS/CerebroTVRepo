...
class sources:
    ...
    def play(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, meta, select):
        try:
            ...
            from resources.lib.scrapermods.player import player
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.origin2.container.items'

        self.metaProperty = 'plugin.video.origin2.container.meta'
