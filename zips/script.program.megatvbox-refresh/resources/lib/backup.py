...
class XbmcBackup:
    ...
    def run(self,mode=-1,progressOverride=False):
        ...
        if(mode == self.Backup):
            ...
            if(self.restore_point.split('.')[-1] == 'zip'):
                ...
                if(not extractor.extract(zip_vfs, xbmc.translatePath("special://temp/"), self.progressBar)):
                    ...
                    #xbmcgui.Dialog.ok("Cerebro TV","Error extracting the zip archive")
                    return
        ...
        self.progressBar.updateProgress(100,"[COLOR gold]Update Complete Applying Changes....[/COLOR]")
        xbmc.sleep(200)
