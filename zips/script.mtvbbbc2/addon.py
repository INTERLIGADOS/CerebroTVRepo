...
def menuoptions():
    ...
    call = dialog.select('[B][COLOR=yellow]Cerebro TV[/COLOR][COLOR=red] BBC 2 Links[/COLOR][/B]', 
    ['[B][COLOR=green]      BBC2 HD[/COLOR][/B]' ,
    '[B][COLOR=green]      BBC2 SD[/COLOR][/B]',
    '[B][COLOR=green]      BBC2 SD[/COLOR][/B]'])
...
def function3():
    xbmc.executebuiltin('PlayMedia("plugin://plugin.video.livehub2/?url=http%3A%2F%2F95.154.237.88%3A8080%2FMatH33Raaabeebyc-2%2FStrm%2Findex.m3u8%7CUser-Agent%3DAppleCoreMedia%2F1.0.0.13A452+%28iPhone%3B+U%3B+CPU+OS+9_0_2+like+Mac+OS+X%3B+en_gb%29&mode=9999&name=BBC+2&iconimage=http%253A%252F%252Fsmarterlogix.com%252FiosSecureApps%252FPakIndiaTVHD%252FV1-2%252FImages%252Fsports.jpg&description=")')
