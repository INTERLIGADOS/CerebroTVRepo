...
addon_id   = 'script.module.rsiptv'

icon       = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'icon.png'))
fanart     = xbmc.translatePath(os.path.join('https://i.imgur.com/dF1zgcB.jpg')) 

def cat():
	addDir('[COLOR blue]C[/COLOR]HANNELS','channels',4,'http://img2.turbomilk.com/portfolio/new/an-msdn-tv-logo.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	addDir('[COLOR blue]S[/COLOR]PORTS','sports',4,'https://i.imgur.com/3py0Se0.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	addDir('[COLOR blue]N[/COLOR]EWS','news',4,'https://affirmativhealth.com/wp-content/uploads/2017/01/NewsWatch-Logo-Mark-Only--768x897.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	addDir('[COLOR blue]K[/COLOR]IDS','kids',4,'http://www.breakinoutfestival.com/wp-content/uploads/2017/07/Breathtaking-Kids-Ministry-Logo-40-On-Logo-Design-with-Kids-Ministry-Logo-945x1223.jpg',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	addDir('[COLOR blue]M[/COLOR]OVIES 24/7','movies',4,'http://www.ask4glass.co.uk/images/targetwebsite35.nrgdigital.net/images/round_24-7_logo__cropped_.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	addDir('[COLOR blue]TV[/COLOR] SHOWS 24/7','shows',4,'http://www.ask4glass.co.uk/images/targetwebsite35.nrgdigital.net/images/round_24-7_logo__cropped_.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	addDir('[COLOR blue]M[/COLOR]USIC','music',4,'http://pngimages.net/sites/default/files/blue-note-symbol-png-image-44184.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
	...
	#addDir('IPTV Restream','iptvrestream',4,'https://1.bp.blogspot.com/-SnEmyxvBHxA/WDW4v6asHAI/AAAAAAAAUac/QBXOMnYAH2Y8MNS1qDbJxgswJpnBfcgAACLcB/s1600/14494667_992633267526877_2246028541223869412_n.jpg',fanart,'')
...
def sports():
        import re
        file = xbmc.translatePath('special://home/addons/script.module.rsiptv/resources/')
        if os.path.exists(file):
            ...
            all   = re.compile('\n([^:]+):(mpd://[^\n]+)').findall(data)
            for name,url in all:
				addDir('%s'%name,url,10,'https://i.imgur.com/3py0Se0.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
...
def channels():
        ...
        if os.path.exists(file):
            ...
            all   = re.compile('\n([^:]+):(mpd://[^\n]+)').findall(data)
            for name,url in all:
				addDir('%s'%name,url,10,'http://img2.turbomilk.com/portfolio/new/an-msdn-tv-logo.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
...
def news():
        ...
        if os.path.exists(file):
            ...
            all   = re.compile('\n([^:]+):(mpd://[^\n]+)').findall(data)
            for name,url in all:
				addDir('%s'%name,url,10,'https://affirmativhealth.com/wp-content/uploads/2017/01/NewsWatch-Logo-Mark-Only--768x897.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
...
def kids():
        ...
        if os.path.exists(file):
            ...
            all   = re.compile('\n([^:]+):(mpd://[^\n]+)').findall(data)
            for name,url in all:
				addDir('%s'%name,url,10,'http://www.breakinoutfestival.com/wp-content/uploads/2017/07/Breathtaking-Kids-Ministry-Logo-40-On-Logo-Design-with-Kids-Ministry-Logo-945x1223.jpg',fanart,'https://i.imgur.com/dF1zgcB.jpg')
...
def music():
        ...
        if os.path.exists(file):
            ...
            all   = re.compile('\n([^:]+):(mpd://[^\n]+)').findall(data)
            for name,url in all:
				addDir('%s'%name,url,10,'http://pngimages.net/sites/default/files/blue-note-symbol-png-image-44184.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
...
def movies():
        ...
        if os.path.exists(file):
            ...
            all   = re.compile('\n([^:]+):(mpd://[^\n]+)').findall(data)
            for name,url in all:
				addDir('%s'%name,url,10,'http://www.ask4glass.co.uk/images/targetwebsite35.nrgdigital.net/images/round_24-7_logo__cropped_.png',fanart,'https://i.imgur.com/dF1zgcB.jpg')
...
logfile    = xbmc.translatePath(os.path.join('special://home/addons/script.module.rsiptv', 'log.txt'))
