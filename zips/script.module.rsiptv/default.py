...
fanart     = xbmc.translatePath(os.path.join('https://i.imgur.com/dF1zgcB.jpg' + addon_id , 'fanart.jpg'))
logfile    = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'log.txt'))

def home():
	
	addDir('[COLOR white]Android IPTV[/COLOR]','url',4000,'https://i.imgur.com/h8khphr.png',fanart,'')	
...
def popupd(announce):
	...
	class TextBox():
		...
		def setControls(self):
			self.win.getControl(self.CONTROL_LABEL).setLabel('[COLOR blue]RS[/COLOR]IPTV') # set heading
